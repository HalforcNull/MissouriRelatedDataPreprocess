...
tblTreatable <- allRead %>% select(one_of(c( "MCF7NT1", "MCF7NT2", "MCF7NT3", "PC3NT1", "PC3NT2", "PC3NT3", "PC3MNT1", "PC3MNT2", "PC3MNT3" ) ) )
tblUnTreatable <- allRead %>% select(one_of(c( "X184A1NT1", "X184A1NT2", "X184A1NT3", "C32NT1", "C32NT2", "C32NT3", "CCD18NT1", "CCD18NT2", "CCD18NT3", "HEMNT1", "HEMNT2", "HEMNT3", "HT29NT1", "HT29NT2", "HT29NT3", "PANCNT1", "PANCNT2", "PANCNT3", "RWNT1", "RWNT2", "RWNT3", "hTERTNT1", "hTERTNT2", "hTERTNT3" ) ) )
...
for( i in 1:nrow(ttraining) ){
  ...
  predictedResult = c(predictedResult, tmp.pre.label)
