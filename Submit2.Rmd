...
length(Exp1)
LFCTable <- cbind(ExpGroup$Gene, Exp1,Exp2,Exp3,Ctrl1,Ctrl2,Ctrl3,Ctrl4,Ctrl5,Ctrl6,Ctrl7,Ctrl8) 

dim(LFCTable)
colnames(LFCTable) <- c('Gene', 'Exp_1','Exp_2','Exp_3','Ctrl_1','Ctrl_2','Ctrl_3','Ctrl_4','Ctrl_5','Ctrl_6','Ctrl_7','Ctrl_8')
LFCTable[is.na(LFCTable)] <- 0
write.csv(LFCTable, file='Phase_2_Result/Filtered_LFC_Result.csv', row.names = FALSE)
